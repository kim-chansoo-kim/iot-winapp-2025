...
using System.Diagnostics; // 진단네임스페이스에 Debug클래스가 포함되어있음
using System.Linq;
...
namespace SyntaxWinApp02
{
    ...
    {
        public Computer() {
            Debug.WriteLine("[디버그]Computer객체 생성 - 디버그");
            Console.WriteLine("Computer 객체 생성 - 그냥 실행");
        }

        bool powerOn;
        public void Boot() { Console.WriteLine("컴퓨터 부팅!!"); }
        public virtual void ShutDown() { Console.WriteLine("컴퓨터 셧다운!!"); }
        public void Reset() { }
    }

    // C++에서는 다중상속이 가능, C#은 불가능
    // Java, C#은 다중상속을 막음
    internal class Notebook : Computer, IMobile, IMessageFilter, IOrderedQueryable
    {
        ...
        {
            string phoneList = "010-0000-0000;010-9999-9999;";
            return phoneList;
        }
