    ...
    public partial class FrmMain : Form
    {
        ...
        private void BtnCheck_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                person.Age = Convert.ToInt32(NudAge.Value); // 이방식 선호
            ...
            {
                MessageBox.Show("성별은 M/F 중 한글자만 입력하세요", "예외", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
